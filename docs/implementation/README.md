...
| 문서 | 담당 범위 | 현재 상태 |
|------|-----------|-----------|
| [Cobblemon 1.8 호환성 검증 기록](COBBLEMON_1_8_COMPATIBILITY.md) | 공식 1.8 스냅샷 기준 자체 모드 빌드 결과와 전체 팩 전환 차단 조건 | 자체 모드 통과·전체 팩 대기 |
...
| [플레이어 메뉴](PLAYER_MENU.md) | 인벤토리 키 기반 가방·포켓몬·도감·지도·퀘스트·트레이너 카드·PC·장비 진입점 | 본가식 세로 리스트 구현 |
...
| [포켓몬 서식지·출현 설정 작업 지침](POKEMON_ENCOUNTER_AUTHORING.md) | 길·바다·낚시·박치기·숲·동굴·던전 출현 데이터의 책임과 작업 체크리스트 | 운영 기준 |
...
| [NPC 이벤트 스크립트 V2 구현 계획](NPC_EVENT_SCRIPT_V2.md) | CVES 전용 언어, RPG Maker식 트리 편집기(게임 내 대화 스킨 제외), 비동기 중단·재개와 EasyNPC 어댑터 | 계획 작성 |
| [CVES 서버 런타임 코어 V1](CVES_SERVER_RUNTIME_CORE_V1.md) | Runtime IR 검증, 세션 직렬화, 일회성 작업 저널과 공통 await 어댑터 | 1차 구현 |
