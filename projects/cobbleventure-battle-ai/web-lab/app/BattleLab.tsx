...
type BattleEngineChoice = "showdown" | "cobbleventure";
...
const RECENT_TRAINERS_KEY = "cobbleventure-battle-lab:recent-trainers";
const LAST_BATTLE_KEY = "cobbleventure-battle-lab:last-battle";
const EVE_REPORT_KEY = "cobbleventure-battle-lab:eve-report";
const PARTY_ORDERS_KEY = "cobbleventure-battle-lab:party-orders";
const CUSTOM_ENTRIES_KEY = "cobbleventure-battle-lab:custom-entries";
            ...
            <article key={slot}>
              ...
              {entry ? (
                <>
                  ...
                  <small>
                    T{entry.save.turn} ·{" "}
                    {entry.save.battleEngine === "cobbleventure"
                      ? "자체 엔진"
                      : "Showdown"}{" "}
...
function InteractiveArena({
  ...
  const reproductionJson = useMemo(
    () =>
      JSON.stringify(
        battle.reproduction ?? {
          schema: "cobbleventure-interactive-battle-snapshot",
          version: 1,
          battle,
        },
        null,
  ...
  const downloadReproductionLog = () => {
    ...
    link.href = url;
    link.download = `cobbleventure-reproduction-${battle.scenarioId}-${battle.turns}.json`;
    link.click();
  ...
  const isNativeBattle =
    battle.engine?.id === "cobbleventure-simple" ||
    battle.settings?.battleEngine === "cobbleventure";
...
export function BattleLab() {
  ...
  const prepareTest = async (
    ...
    if (!ready) {
      setNotice(
        !formatSupported
          ? "Cobbleventure 자체 엔진은 현재 싱글 배틀만 지원합니다."
    ...
    const requestBody =
      mode === "pve"
        ? {
            ...
            battleType,
            battleEngine,
            gimmickRules: battleEngine === "cobbleventure" ? "all" : gimmickRules,
            aiDifficulty,
            aiProfiles: [
  ...
  return (
    <main className="lab-shell">
      <header className="topbar">
        <a className="brand" href="#top" aria-label="Cobbleventure Battle Lab 홈">
          <span className="brand-mark" aria-hidden="true">
            CV
          </span>
          <span>
            <strong>Cobbleventure</strong>
            ...
            <form onSubmit={saveWorkspace}>
              <div className="workspace-path-field">
                <label htmlFor="mod-workspace-path">
                  ...
                  <small>Cobbleventure 작업공간 또는 mods 폴더</small>
                </label>
                <div className="workspace-path-input">
                  <input
                    ...
                    placeholder="예: G:\CobbleventureTrainerWebEditorWorkspace"
                    spellCheck={false}
                    autoFocus
                  />
                  <button
              ...
              <div className="workspace-path-field">
                ...
                <div className="workspace-path-input">
                  <input
                    ...
                    placeholder="예: G:\Cobbleventure\resourcepacks"
                    spellCheck={false}
                  />
                  <button
                    type="button"
      ...
      >
        ...
        <label>
          ...
          <TournamentSelect
            ariaLabel="기믹 규칙"
            value={battleEngine === "cobbleventure" ? "all" : gimmickRules}
            disabled={battleEngine === "cobbleventure"}
            options={[
              {
                value: "all",
        ...
        <label>
          ...
          <TournamentSelect
            ...
            options={[
              ...
              {
                value: "cobbleventure",
                label: "Cobbleventure 자체 엔진 · 싱글 전용",
              },
            ]}
            onChange={(value) => {
          ...
          />
          {battleEngine === "cobbleventure" && battleType !== "single" ? (
