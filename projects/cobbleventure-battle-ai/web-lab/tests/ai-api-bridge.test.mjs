...
test("converts a Cobbleventure simple state into the common AI observation model", () => {
  ...
  assert.equal(observation.battleType.engine, "cobbleventure-simple");
