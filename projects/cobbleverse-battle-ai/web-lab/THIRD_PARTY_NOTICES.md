...
Cobbleverse Battle AI does not treat this dependency as its final AI implementation. It supplies a working mechanics baseline and later serves as a differential-test oracle for the independent Cobbleverse rules engine.
