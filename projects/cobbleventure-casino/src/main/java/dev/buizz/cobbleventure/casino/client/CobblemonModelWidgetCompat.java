...
/** Supports both Cobblemon ModelWidget constructor variants used by the pack. */
final class CobblemonModelWidgetCompat {
    ...
    static ModelWidget create(
        int x, int y, int width, int height, RenderablePokemon pokemon,
        float baseScale, float rotationY, double offsetY,
        boolean playCryOnClick, boolean shouldFollowCursor
    ) {
        try {
