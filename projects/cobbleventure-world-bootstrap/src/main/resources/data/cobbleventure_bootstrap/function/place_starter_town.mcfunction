...
execute positioned ~32 ~ ~32 positioned over motion_blocking_no_leaves store success storage cobbleventure_bootstrap:state starter_town.placed byte 1 run place structure cobbleventure:starter_town/village ~ ~ ~
